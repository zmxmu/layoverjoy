...
declare const PutBucketRequestPaymentCommand_base: {
    new (input: PutBucketRequestPaymentCommandInput): import("@smithy/core/client").CommandImpl<PutBucketRequestPaymentCommandInput, PutBucketRequestPaymentCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBucketRequestPaymentCommandInput): import("@smithy/core/client").CommandImpl<PutBucketRequestPaymentCommandInput, PutBucketRequestPaymentCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
