...
declare const GetBucketAccelerateConfigurationCommand_base: {
    new (input: GetBucketAccelerateConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAccelerateConfigurationCommandInput, GetBucketAccelerateConfigurationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketAccelerateConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAccelerateConfigurationCommandInput, GetBucketAccelerateConfigurationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
