...
declare const PutBucketPolicyCommand_base: {
    new (input: PutBucketPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutBucketPolicyCommandInput, PutBucketPolicyCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBucketPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutBucketPolicyCommandInput, PutBucketPolicyCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
