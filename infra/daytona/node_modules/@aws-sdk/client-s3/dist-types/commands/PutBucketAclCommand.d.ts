...
declare const PutBucketAclCommand_base: {
    new (input: PutBucketAclCommandInput): import("@smithy/core/client").CommandImpl<PutBucketAclCommandInput, PutBucketAclCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBucketAclCommandInput): import("@smithy/core/client").CommandImpl<PutBucketAclCommandInput, PutBucketAclCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
