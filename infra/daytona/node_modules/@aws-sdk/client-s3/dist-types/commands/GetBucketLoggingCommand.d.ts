...
declare const GetBucketLoggingCommand_base: {
    new (input: GetBucketLoggingCommandInput): import("@smithy/core/client").CommandImpl<GetBucketLoggingCommandInput, GetBucketLoggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketLoggingCommandInput): import("@smithy/core/client").CommandImpl<GetBucketLoggingCommandInput, GetBucketLoggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
