...
declare const PutBucketTaggingCommand_base: {
    new (input: PutBucketTaggingCommandInput): import("@smithy/core/client").CommandImpl<PutBucketTaggingCommandInput, PutBucketTaggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBucketTaggingCommandInput): import("@smithy/core/client").CommandImpl<PutBucketTaggingCommandInput, PutBucketTaggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
