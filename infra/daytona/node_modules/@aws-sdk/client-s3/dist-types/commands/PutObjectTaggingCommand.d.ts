...
declare const PutObjectTaggingCommand_base: {
    new (input: PutObjectTaggingCommandInput): import("@smithy/core/client").CommandImpl<PutObjectTaggingCommandInput, PutObjectTaggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutObjectTaggingCommandInput): import("@smithy/core/client").CommandImpl<PutObjectTaggingCommandInput, PutObjectTaggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
