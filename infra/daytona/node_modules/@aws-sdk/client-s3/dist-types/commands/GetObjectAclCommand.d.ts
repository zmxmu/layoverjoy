...
declare const GetObjectAclCommand_base: {
    new (input: GetObjectAclCommandInput): import("@smithy/core/client").CommandImpl<GetObjectAclCommandInput, GetObjectAclCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetObjectAclCommandInput): import("@smithy/core/client").CommandImpl<GetObjectAclCommandInput, GetObjectAclCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
