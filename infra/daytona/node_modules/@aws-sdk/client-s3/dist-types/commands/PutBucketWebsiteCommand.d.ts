...
declare const PutBucketWebsiteCommand_base: {
    new (input: PutBucketWebsiteCommandInput): import("@smithy/core/client").CommandImpl<PutBucketWebsiteCommandInput, PutBucketWebsiteCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBucketWebsiteCommandInput): import("@smithy/core/client").CommandImpl<PutBucketWebsiteCommandInput, PutBucketWebsiteCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
