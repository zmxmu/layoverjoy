...
declare const GetBucketTaggingCommand_base: {
    new (input: GetBucketTaggingCommandInput): import("@smithy/core/client").CommandImpl<GetBucketTaggingCommandInput, GetBucketTaggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketTaggingCommandInput): import("@smithy/core/client").CommandImpl<GetBucketTaggingCommandInput, GetBucketTaggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
