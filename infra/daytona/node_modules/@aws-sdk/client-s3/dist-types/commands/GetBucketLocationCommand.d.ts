...
declare const GetBucketLocationCommand_base: {
    new (input: GetBucketLocationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketLocationCommandInput, GetBucketLocationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketLocationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketLocationCommandInput, GetBucketLocationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
