...
declare const GetBucketAbacCommand_base: {
    new (input: GetBucketAbacCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAbacCommandInput, GetBucketAbacCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketAbacCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAbacCommandInput, GetBucketAbacCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
