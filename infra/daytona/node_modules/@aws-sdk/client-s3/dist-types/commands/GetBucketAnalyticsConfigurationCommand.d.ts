...
declare const GetBucketAnalyticsConfigurationCommand_base: {
    new (input: GetBucketAnalyticsConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAnalyticsConfigurationCommandInput, GetBucketAnalyticsConfigurationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketAnalyticsConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAnalyticsConfigurationCommandInput, GetBucketAnalyticsConfigurationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
