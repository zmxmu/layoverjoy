...
declare const PutBucketVersioningCommand_base: {
    new (input: PutBucketVersioningCommandInput): import("@smithy/core/client").CommandImpl<PutBucketVersioningCommandInput, PutBucketVersioningCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBucketVersioningCommandInput): import("@smithy/core/client").CommandImpl<PutBucketVersioningCommandInput, PutBucketVersioningCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
