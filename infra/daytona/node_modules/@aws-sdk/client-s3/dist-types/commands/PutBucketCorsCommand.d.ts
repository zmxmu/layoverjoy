...
declare const PutBucketCorsCommand_base: {
    new (input: PutBucketCorsCommandInput): import("@smithy/core/client").CommandImpl<PutBucketCorsCommandInput, PutBucketCorsCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBucketCorsCommandInput): import("@smithy/core/client").CommandImpl<PutBucketCorsCommandInput, PutBucketCorsCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
