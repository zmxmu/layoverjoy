...
declare const GetBucketWebsiteCommand_base: {
    new (input: GetBucketWebsiteCommandInput): import("@smithy/core/client").CommandImpl<GetBucketWebsiteCommandInput, GetBucketWebsiteCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketWebsiteCommandInput): import("@smithy/core/client").CommandImpl<GetBucketWebsiteCommandInput, GetBucketWebsiteCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
