...
declare const GetObjectLegalHoldCommand_base: {
    new (input: GetObjectLegalHoldCommandInput): import("@smithy/core/client").CommandImpl<GetObjectLegalHoldCommandInput, GetObjectLegalHoldCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetObjectLegalHoldCommandInput): import("@smithy/core/client").CommandImpl<GetObjectLegalHoldCommandInput, GetObjectLegalHoldCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
