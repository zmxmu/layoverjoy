...
declare const GetBucketAclCommand_base: {
    new (input: GetBucketAclCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAclCommandInput, GetBucketAclCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketAclCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAclCommandInput, GetBucketAclCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
