...
declare const GetBucketInventoryConfigurationCommand_base: {
    new (input: GetBucketInventoryConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketInventoryConfigurationCommandInput, GetBucketInventoryConfigurationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketInventoryConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketInventoryConfigurationCommandInput, GetBucketInventoryConfigurationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
