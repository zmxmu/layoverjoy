...
declare const DeleteBucketTaggingCommand_base: {
    new (input: DeleteBucketTaggingCommandInput): import("@smithy/core/client").CommandImpl<DeleteBucketTaggingCommandInput, DeleteBucketTaggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteBucketTaggingCommandInput): import("@smithy/core/client").CommandImpl<DeleteBucketTaggingCommandInput, DeleteBucketTaggingCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
