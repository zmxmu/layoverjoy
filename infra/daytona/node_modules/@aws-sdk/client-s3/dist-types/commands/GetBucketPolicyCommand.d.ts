...
declare const GetBucketPolicyCommand_base: {
    new (input: GetBucketPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetBucketPolicyCommandInput, GetBucketPolicyCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetBucketPolicyCommandInput, GetBucketPolicyCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
