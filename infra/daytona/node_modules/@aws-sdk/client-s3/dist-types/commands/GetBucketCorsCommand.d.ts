...
declare const GetBucketCorsCommand_base: {
    new (input: GetBucketCorsCommandInput): import("@smithy/core/client").CommandImpl<GetBucketCorsCommandInput, GetBucketCorsCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketCorsCommandInput): import("@smithy/core/client").CommandImpl<GetBucketCorsCommandInput, GetBucketCorsCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
