...
declare const GetBucketRequestPaymentCommand_base: {
    new (input: GetBucketRequestPaymentCommandInput): import("@smithy/core/client").CommandImpl<GetBucketRequestPaymentCommandInput, GetBucketRequestPaymentCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketRequestPaymentCommandInput): import("@smithy/core/client").CommandImpl<GetBucketRequestPaymentCommandInput, GetBucketRequestPaymentCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
