...
import { DaytonaInvalidArgumentError, DaytonaNotFoundError } from './errors/DaytonaError.js';
...
export class Image {
    ...
    static processPythonVersion(pythonVersion) {
        ...
        if (!SUPPORTED_PYTHON_SERIES.includes(pythonVersion)) {
            throw new DaytonaInvalidArgumentError(`Unsupported Python version: ${pythonVersion}. ` +
