...
let Process = (() => {
    ...
    return class Process {
        ...
        async createPty(options) {
            ...
            const handle = new PtyHandle(ws, (handleCols, handleRows) => this.resizePtySession(id, handleCols, handleRows), () => this.killPtySession(id), options.onData, id);
